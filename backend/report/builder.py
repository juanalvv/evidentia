"""Assemble ScholarCounter analysis JSON into a markdown report."""
...
def build_report(data: dict[str, Any]) -> dict[str, str]:
    ...
    lines.append(f"# ScholarCounter Report: {title}")
    ...
    lines.append("---")
    lines.append("*Generated by ScholarCounter (Evidentia) — Hack-a-Claw Cloud Track*")
    return {"markdown": "\n".join(lines)}
