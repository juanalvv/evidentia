...
class SemanticScholarStub:
    ...
    async def find_contradiction_signals(self, title: Optional[str] = None, doi: Optional[str] = None) -> List[str]:
...
class LLMStub:
    ...
    async def complete(self, prompt: str, model: str, max_tokens: int = 128) -> str:
